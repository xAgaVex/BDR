...
test('kupienie produktu przez nowego uzytkownika', async ({ page }) => {
  ...
  await page.locator('css=#order_bill_address_attributes_firstname').fill('Aleks');
  await page.locator('css=#order_bill_address_attributes_lastname').fill('Kowal');
  ...
  await page.locator('css=#order_bill_address_attributes_phone').fill('969696969');
  await page.getByText('Order use billing').click();
  await page.locator('css=#order_ship_address_attributes_firstname').fill('Aleks');
  await page.locator('css=#order_ship_address_attributes_lastname').fill('Kowal');
  await page.locator('css=#order_ship_address_attributes_address1').fill('Zbożowa 14');
  ...
  await page.locator('css=#order_ship_address_attributes_zipcode').fill('70-320');
  await page.locator('css=#order_ship_address_attributes_phone').fill('696969696');
